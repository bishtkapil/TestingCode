...
@section('page-title', 'Distribution Dashboard')
...
@section('page-body')
    @if (in_array('addStock', $current_user_permission))
        <div class="m-b-20">
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="" class="btn btn-sm btn-primary btn-grd-primary">+ Add New Item</a>
                </div>
            </div>
        </div>
    @endif
                        ...
                        <table id="table-id" class="table table-striped table-bordered js-serial">
                            <thead>
                                <tr>
                                    ...
                                    <th>Distribute Post</th>
                                    <th>Distribution Date / Time</th>

                                </tr>
                            </thead>
                            <tbody>
                            @foreach($distribute as $list)
                            <tr>
